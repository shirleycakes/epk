...
function Oq(){}
var Nq="";function Pq(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&Ng(c)}}
...
x(Uq,P);var Vq=new Q("ypc-core-load",Qq),Wq=new Q("ypc-guide-sync-success",Rq),Xq=new Q("ypc-purchase-success",Sq),Yq=new Q("ypc-subscription-cancel",Uq),Zq=new Q("ypc-subscription-cancel-success",Tq),$q=new Q("ypc-init-subscription",Uq);var ar=!1,br=[],cr=[];function dr(a){a.f?ar?R(bi,a):R(Vq,new Qq(function(){R($q,new Uq(a.f))})):er(a.h,a.l,a.j,a.source)}
function fr(a){a.f?ar?R(gi,a):R(Vq,new Qq(function(){R(Yq,new Uq(a.f))})):gr(a.h,a.subscriptionId,a.l,a.j,a.source)}
function hr(a){ir(Ya(a.f))}
function jr(a){kr(Ya(a.f))}
function lr(a){mr(a.f,a.isEnabled,null)}
function nr(a,b,c,d){mr(a,b,c,d)}
function or(a){var b=a.h,c=a.f.subscriptionId;b&&c&&R(ai,new Th(b,c,a.f.channelInfo))}
function pr(a){var b=a.f;eb(a.h,function(a,d){R(ai,new Th(d,a,b[d]))})}
function qr(a){R(fi,new Qh(a.h.itemId));a.f&&a.f.length&&(rr(a.f,fi),rr(a.f,hi))}
function er(a,b,c,d){var e=new Qh(a);R(Zh,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&sr(b,c);Wd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",ac:f,S:c,ca:function(b,c){var d=c.response;R(ai,new Th(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&K("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Pq(d.actions)},
Xb:function(){R($h,e)}})}
function gr(a,b,c,d,e){var f=new Qh(a);R(di,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&sr(c,d);Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",ac:h,S:d,ca:function(a,b){var c=b.response;R(fi,f);c.actions&&Pq(c.actions)},
Xb:function(){R(ei,f)}})}
function mr(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);Wd("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",S:e,onError:function(){d&&d()}})}}
function ir(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-subscribe-loading");rr(b,Zh);var c={};c.a=b.join(",");var d=function(){R("subscription-batch-subscribe-loaded");rr(b,$h)};
...
function kr(a){if(a.length){var b=$a(a,0,40);R("subscription-batch-unsubscribe-loading");rr(b,di);var c={};c.c=b.join(",");var d=function(){R("subscription-batch-unsubscribe-loaded");rr(b,ei)};
Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",S:c,ca:function(){d();rr(b,fi);a.length&&kr(a)},
onError:function(){d()}})}}
function rr(a,b){y(a,function(a){R(b,new Qh(a))})}
function sr(a,b){var c=Nd(a),d;for(d in c)b[d]=c[d]}
;var tr,ur=null,vr=null,wr=null,xr=!1;
function yr(){var a=G("PLAYER_CONFIG",void 0),b=G("REVERSE_MOBIUS_PERCENT",void 0);if(dg&&100*Math.random()<b)try{var c=r("yt.www.ads.biscotti");(c?c.getId():Jq()).then(Mq,Oq)}catch(e){pc(e)}if(G("REQUEST_POST_MESSAGE_ORIGIN")){if(!tr){tr=new Ii;tr.f=yr;return}tr.origin&&"*"!=tr.origin&&(a.args.post_message_origin=tr.origin)}var d=document.referrer,b=G("POST_MESSAGE_ORIGIN"),c=!1;u(d)&&u(b)&&-1<d.indexOf(b)&&Ig(b)&&Ig(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);G("LIGHTWEIGHT_AUTOPLAY")&&
(a.args.autoplay="1");a.args.autoplay&&gj(a.args);ur=Dh("player",a);d=G("POST_MESSAGE_ID","player");G("ENABLE_JS_API")?wr=new Bq(ur):G("ENABLE_POST_API")&&u(d)&&u(b)&&(vr=new Dq(window.parent,d,b),wr=new xq(ur,vr.h));(xr=c&&!G("ENABLE_CAST_API"))?a.args.disableCast="1":(a=ur,up(),dq=a,dq.addEventListener("onReady",fq),dq.addEventListener("onRemoteReceiverSelected",hq),eq.push(xc("yt-remote-receiver-availability-change",gq)),eq.push(xc("yt-remote-auto-connect",iq)));G("BG_P")&&(G("BG_I")||G("BG_IU"))&&
Mc();ge();jq=ur;jq.addEventListener("SUBSCRIBE",mq);jq.addEventListener("UNSUBSCRIBE",pq);kq.push(Vg(ai,qq),Vg(fi,rq))}
...
q("writeEmbed",yr,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a=a+"mac_204?action_fcts=1")&&Ng(a);return!0},void 0);
var zr=nc(function(){ah("ol");ar=!0;cr.push(Vg(Yh,dr),Vg(ci,fr));ar||(cr.push(Vg(bi,dr),Vg(gi,fr),Vg(Vh,hr),Vg(Wh,jr),Vg(Xh,lr)),br.push(xc("subscription-prefs",nr)),cr.push(Vg(Xq,or),Vg(Zq,qr),Vg(Wq,pr)));Cf.getInstance();var a=1<window.devicePixelRatio;if(Hf(0,119)!=a){var b="f"+(Math.floor(119/31)+1),c=Gf(b)||0,c=a?c|67108864:c&-67108865;0==c?delete Df[b]:(a=c.toString(16),Df[b]=a.toString());var d,b=[];for(d in Df)b.push(d+"="+escape(Df[d]));d=b.join("&");bf("PREF",d,63072E3)}}),Ar=nc(function(){var a=
ur;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();G("PL_ATT")&&(Lc=null);for(var a=0,b=ee.length;a<b;a++){var c=ee[a],d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}ee.length=0;a=Hc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Cc(a),b.parentNode.removeChild(b);fe=!1;lc("DCLKSTAT",0);zc(br);br.length=0;Wg(cr);cr.length=0;ar=!1;jq&&(jq.removeEventListener("SUBSCRIBE",nq),jq.removeEventListener("UNSUBSCRIBE",pq));jq=null;Wg(kq);kq.length=0;xr||(zc(eq),eq.length=
0,dq&&(dq.removeEventListener("onRemoteReceiverSelected",hq),dq.removeEventListener("onReady",fq),dq=null),Kp());hc(wr,vr);ur&&ur.destroy()});
window.addEventListener?(window.addEventListener("load",zr),window.addEventListener("unload",Ar)):window.attachEvent&&(window.attachEvent("onload",zr),window.attachEvent("onunload",Ar));var Br=Ci.getInstance(),Cr=qi(Br);Cr in Hi||(Br.register(),Br.Jc.push(xc("yt-uix-init-"+Cr,Br.init,Br)),Br.Jc.push(xc("yt-uix-dispose-"+Cr,Br.dispose,Br)),Hi[Cr]=Br);})();
